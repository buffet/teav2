...
namespace teav2 {
	...
	std::string Client::get_user_name(std::int32_t user_id) {
	...
	void Client::process_update(td_api::object_ptr<td_api::Object> update) {
	...
	std::function<void(Object)> Client::create_authentication_query_handler() {
	...
	void Client::Client::check_authentication_error(Object object) {
		if (object->get_id() == td_api::error::ID) {
